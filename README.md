...
- [Game-icons.net](https://game-icons.net/) for the awesome icons used in the Node View! In particular, the icons used have been made by
  - [Delapouite](https://delapouite.com/)
    - [mob](/assets/nodegraph/mob.svg), [item](/assets/nodegraph/item.svg), [placeholder](/assets/nodegraph/placeholder.svg), [stat](/assets/nodegraph/stat.svg), [achievement](/assets/nodegraph/achievement.svg)
